...
**독서 DNA(`reading-dna.html`)** 는 **미드나잇 잉크** 다크 테마를 씁니다 (2026-06-25, 기존 크림·테라코타 클래식 톤에서 현대적 다크 에디토리얼로 전환). 어두운 잉크빛 배경 위에 민트·바이올렛·코랄·앰버 악센트를 얹어, 숫자와 차트가 빛나듯 도드라지게 했습니다.
